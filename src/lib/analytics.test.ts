...
const bread: Item = { id: "i1", name: "Bread", emoji: "🍞", imageUrl: null, category: "Breads", unit: "pcs", price: 40, costPrice: 20, hsn: "", gstRate: 0, qty: 5, tracksExpiry: true, earliestExpiry: null, batches: [] };
const breadLine = { itemId: "i1", name: "Bread", emoji: "🍞", imageUrl: null, unit: "pcs", qty: 2, price: 40, costPrice: 20, hsn: "", gstRate: 0, taxableValue: 0, cgst: 0, sgst: 0, igst: 0, };
